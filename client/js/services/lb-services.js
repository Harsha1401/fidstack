  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Question#searchQuestions
         * @methodOf lbServices.Question
         *
         * @description
         *
         ...
         */
        "searchQuestions": {
          url: urlBase + "/questions/searchQuestions",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Answer.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/answers/:id/comments/:fk",
          method: "GET"
        },

        // INTERNAL. Use Answer.comments.destroyById() instead.
        ...
        // INTERNAL. Use Answer.comments.updateById() instead.
        ...
        // INTERNAL. Use Answer.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
          url: urlBase + "/answers/:id/comments",
          method: "GET"
        },

        // INTERNAL. Use Answer.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/answers/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Answer.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/answers/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Answer.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/answers/:id/comments/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Answer.comments
     * @header lbServices.Answer.comments
     * @object
     * @description
     *
     * The object `Answer.comments` groups methods
     * manipulating `Comment` instances related to `Answer`.
     *
     * Call {@link lbServices.Answer#comments Answer.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          ...
          var action = TargetResource["::get::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#count
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
         * Counts comments of answer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#create
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#createMany
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#destroyAll
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#destroyById
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#findById
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::answer::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Answer.comments#updateById
         * @methodOf lbServices.Answer.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::answer::comments"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Answer.comments.createMany() instead.
        "::createMany::answer::comments": {
          isArray: true,
          url: urlBase + "/answers/:id/comments",
          method: "POST"
        },
